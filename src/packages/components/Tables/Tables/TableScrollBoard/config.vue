  ...
  <CollapseItem name="列表" :expanded="true">
    ...
    <SettingItemBox name="配置" :alone="true">
      <SettingItem name="表头数据">
        <n-input v-model:value="header" :min="1" size="small" placeholder="表头数据(英文','分割)" />
      </SettingItem>
      <SettingItem name="列对齐方式">
        <n-input v-model:value="align" :min="1" size="small" placeholder="对齐方式(英文','分割)" />
      </SettingItem>
    ...
    <SettingItemBox name="样式">
      <SettingItem name="表头背景色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="optionData.headerBGC" />
      </SettingItem>
      <SettingItem name="奇数行背景色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="optionData.oddRowBGC" />
      </SettingItem>
      <SettingItem name="偶数行背景色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="optionData.evenRowBGC" />
      </SettingItem>
    </SettingItemBox>
  </CollapseItem>
</template>
