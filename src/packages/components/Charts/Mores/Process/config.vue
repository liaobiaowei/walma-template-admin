  ...
  <CollapseItem name="进度条" :expanded="true">
    ...
    <SettingItemBox name="轨道">
      ...
      <SettingItem name="进度条颜色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="optionData.color" />
      </SettingItem>
      <SettingItem name="轨道颜色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="optionData.railColor" />
      </SettingItem>
      <setting-item name="偏移角度" v-if="optionData.type !== types[0].value">
        <n-input-number v-model:value="optionData.offsetDegree" size="small" />
      </setting-item>
    ...
    <SettingItemBox name="指标">
      ...
      <setting-item name="文本大小">
        <n-input-number v-model:value="optionData.indicatorTextSize" size="small" />
      </setting-item>
    </SettingItemBox>
  </CollapseItem>
</template>
