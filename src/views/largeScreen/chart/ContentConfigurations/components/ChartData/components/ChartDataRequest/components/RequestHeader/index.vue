  ...
  <n-space vertical>
    <div style="width: 600px">
      <n-tabs v-model:value="requestContentType" type="segment" size="small">
        <n-tab :name="RequestContentTypeEnum.DEFAULT" tab="普通请求" />
        <n-tab :name="RequestContentTypeEnum.SQL" tab="SQL 请求" />
      </n-tabs>
    </div>
    <div v-show="requestContentType === RequestContentTypeEnum.DEFAULT">
      ...
      <div class="go-mt-3">
        <div v-if="tabValue !== RequestParamsTypeEnum.BODY">
          <request-header-table :target="requestParams[tabValue]" @update="updateRequestParams" />
        </div>
...
<script setup lang="ts">
  ...
  import { MonacoEditor } from '/@/components/largeScreen/Pages/MonacoEditor';
  import { SettingItemBox } from '/@/components/largeScreen/Pages/ChartItemSetting';
  import { useTargetData } from '/@/views/largeScreen/chart/ContentConfigurations/components/hooks/useTargetData.hook';
