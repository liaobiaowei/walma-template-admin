<template>
  ...
  <n-card class="n-card-shallow">
    ...
    <n-collapse-transition :show="showTable">
      <request-global-header-table :editDisabled="editDisabled" />
...
<script setup lang="ts">
  ...
  import { selectTimeOptions } from '/@/views/largeScreen/chart/ContentConfigurations/components/ChartData/index.d';
