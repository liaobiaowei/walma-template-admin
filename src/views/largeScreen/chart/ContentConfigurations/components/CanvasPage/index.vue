<template>
  <div class="go-canvas-setting">
    ...
    <n-space vertical :size="12">
      ...
      <n-space>
        <n-text>背景控制</n-text>
        <n-button size="small" :disabled="!canvasConfig.backgroundImage" @click="clearImage"
          >清除背景图</n-button
        >
        <n-button size="small" :disabled="!canvasConfig.background" @click="clearColor"
          >清除颜色</n-button
        >
      </n-space>
      <n-space>
    ...
    <!-- 滤镜 -->
    <styles-setting :is-canvas="true" :chartStyles="canvasConfig" />
...
<script setup lang="ts">
  ...
  import { FileTypeEnum } from '/@/enums/largeScreen/fileTypeEnum';
  import { useChartEditStore } from '/@/store/modules/largeScreen/chartEditStore/chartEditStore';
  import { EditCanvasConfigEnum } from '/@/store/modules/largeScreen/chartEditStore/chartEditStore.d';
  import { StylesSetting } from '/@/components/largeScreen/Pages/ChartItemSetting';
  import { UploadCustomRequestOptions } from 'naive-ui';
  import { fileToUrl, loadAsyncComponent } from '/@/utils/largeScreen';
  import { PreviewScaleEnum } from '/@/enums/largeScreen/styleEnum';
