...
<script setup lang="ts">
  ...
  import { renderIcon, goHome } from '/@/utils/largeScreen';
  ...
  import { HistoryStackEnum } from '/@/store/modules/largeScreen/chartHistoryStore/chartHistoryStore.d';

  import { useChartLayoutStore } from '/@/store/modules/largeScreen/chartLayoutStore/chartLayoutStore';
  import { ChartLayoutStoreEnum } from '/@/store/modules/largeScreen/chartLayoutStore/chartLayoutStore.d';
