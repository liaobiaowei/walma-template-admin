  ...
  <div class="go-content-charts-item-box">
    ...
    >
      <div class="list-header">
        <mac-os-control-btn :mini="true" :disabled="true" />
...
<script setup lang="ts">
  ...
  import { MacOsControlBtn } from '/@/components/largeScreen/Tips/MacOsControlBtn/index';
  import { useChartEditStore } from '/@/store/modules/largeScreen/chartEditStore/chartEditStore';
  import { EditCanvasTypeEnum } from '/@/store/modules/largeScreen/chartEditStore/chartEditStore.d';
  import { componentInstall } from '/@/utils/largeScreen/componets';
  import { DragKeyEnum } from '/@/enums/largeScreen/editPageEnum';
