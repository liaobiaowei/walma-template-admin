    ...
    >
      ...
      <div class="search-list-box">
        <n-scrollbar style="max-height: 500px">
          <n-empty v-show="!searchRes.length" size="small" description="没有找到组件~" />
          <div
...
<script setup lang="ts">
  ...
  import { themeColor } from '../../hooks/useAside.hook';
  import { useChartEditStore } from '/@/store/modules/largeScreen/chartEditStore/chartEditStore';
  import { ConfigType, CreateComponentType } from '/@/packages/index.d';
  import { createComponent } from '/@/packages';
  import { addEventListener, removeEventListener } from '/@/utils/largeScreen';
