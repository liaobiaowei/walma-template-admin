...
import { HistoryActionTypeEnum } from '/@/store/modules/largeScreen/largeScreen/chartHistoryStore/chartHistoryStore.d';
import {
  RequestHttpEnum,
  ...
  RequestParams,
  RequestBodyEnum,
} from '/@/enums/largeScreen/largeScreen/httpEnum';
import { PreviewScaleEnum } from '/@/enums/largeScreen/largeScreen/styleEnum';
