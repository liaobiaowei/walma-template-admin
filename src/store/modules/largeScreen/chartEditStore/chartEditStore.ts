...
// 全局设置
import { useSettingStore } from '/@/store/modules/largeScreen/settingStore/settingStore';
import {
  HistoryActionTypeEnum,
  HistoryItemType,
  HistoryTargetTypeEnum,
} from '/@/store/modules/largeScreen/chartHistoryStore/chartHistoryStore.d';
import { MenuEnum } from '/@/enums/largeScreen/editPageEnum';
import { loadingStart, loadingFinish, loadingError } from '/@/utils/largeScreen';
...
export const useChartEditStore = defineStore({
  ...
  actions: {
    ...
    // * 设置目标数据 select
    setTargetSelectChart(selectId?: any, push = false) {
      // 重复选中
